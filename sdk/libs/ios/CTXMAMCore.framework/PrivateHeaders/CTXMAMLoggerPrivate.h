...
NSString * SanitizeLogMessage(NSString * fmt);
void CTXMAMLOG_MessageWithArgsList(NSString * source, int level, int logType, const char * file, const char * func, int line, NSString * fmt, va_list args);
void CTXMAMLOG_Message_DebugOnly(NSString * source, int level, int logType, const char * file, const char * func,int line, NSString * fmt, ...);
void CTXMAMLOG_Message_Secure(NSString * source, int level, int logType, const char * file, const char * func,int line, NSString * fmt, ...);
int CTXMAMLOG_getLogLevel(void);
BOOL CTXMAMLOG_cleanLogs(void);

static NSArray * _loggerBannedWords = nil;
