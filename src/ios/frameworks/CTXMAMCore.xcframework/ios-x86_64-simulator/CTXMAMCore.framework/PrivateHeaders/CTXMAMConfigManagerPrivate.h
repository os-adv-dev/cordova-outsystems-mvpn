...
@property (readonly)        BOOL                    allowBackgroundDataAccess;
...
-(void) set_allowBackgroundDataAccess:      (BOOL)                  value;
...
- (void) saveVault:(CTXMAMVaultType) vault withCompletionBlock: (void (^)(NSError * nilOrError))completionBlock;
