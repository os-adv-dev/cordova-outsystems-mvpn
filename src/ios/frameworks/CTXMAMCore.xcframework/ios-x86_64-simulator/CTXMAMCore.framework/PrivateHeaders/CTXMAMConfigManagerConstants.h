//
//  CTXMAMConfigManagerConstants.h
//  CTXMAMCore
//
...
#define CONFIGMGR_POLICY_AUTO_REFRESH_INTERVAL                       3600
#define CONFIGMGR_POLICY_KEY_ACTIVE_POLL_PERIOD                      @"ActivePollPeriod"
#define CONFIGMGR_DEFAULT_VALUE_ACTIVE_POLL_PERIOD                   CONFIGMGR_POLICY_AUTO_REFRESH_INTERVAL
...
#define SETTINGS_KEY_ALLOW_BG_DATA_ACCESS                            @"allowBackgroundDataAccess"
#define SETTINGS_KEY_LAST_POLICY_FETCH_TIME                          @"lastPolicyFetchTime"
#define SETTINGS_KEY_LAST_LOGONINFO_FETCH_TIME                       @"lastLogonInfoFetchTime"
...
#define PKEY_POLICYNETWORKACCESS_NEW_MAM_SDKS                        @"MamSdkMvpnNetworkAccess"
#endif /* Constants_h */
...
// Device Vender Key
#define DEVICE_VENDOR_KEY                                           @"FeatureFlagDeviceId"

#define kEMAMSSDK                                                   @"EMAM-S-SDK"
