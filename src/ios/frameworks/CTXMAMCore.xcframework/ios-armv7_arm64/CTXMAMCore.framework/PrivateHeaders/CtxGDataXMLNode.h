...
_EXTERN const char* kGDataXMLXPathDefaultNamespacePrefix_W _INITIALIZE_AS("_def_ns");
...
@class GDataXMLElement_W, GDataXMLDocument_W;

enum {
  GDataXMLInvalidKind_W = 0,
  GDataXMLDocumentKind_W,
  GDataXMLElementKind_W,
  GDataXMLAttributeKind_W,
  GDataXMLNamespaceKind_W,
  GDataXMLProcessingInstructionKind_W,
  GDataXMLCommentKind_W,
  GDataXMLTextKind_W,
  GDataXMLDTDKind_W,
  GDataXMLEntityDeclarationKind_W,
  GDataXMLAttributeDeclarationKind_W,
  GDataXMLElementDeclarationKind_W,
  GDataXMLNotationDeclarationKind_W
};

typedef NSUInteger GDataXMLNodeKind_W;

@interface GDataXMLNode_W : NSObject <NSCopying> {
@protected
...
+ (GDataXMLElement_W *)elementWithName:(NSString *)name;
+ (GDataXMLElement_W *)elementWithName:(NSString *)name stringValue:(NSString *)value;
+ (GDataXMLElement_W *)elementWithName:(NSString *)name URI:(NSString *)value;
...
- (NSArray *)children;
- (GDataXMLNode_W *)childAtIndex:(unsigned)index;
...
@interface GDataXMLElement_W : GDataXMLNode_W

- (id)initWithXMLString:(NSString *)str error:(NSError **)error;

- (NSArray *)namespaces;
- (void)setNamespaces:(NSArray *)namespaces;
- (void)addNamespace:(GDataXMLNode_W *)aNamespace;

// addChild adds a copy of the child node to the element
- (void)addChild:(GDataXMLNode_W *)child;
- (void)removeChild:(GDataXMLNode_W *)child;

- (NSArray *)elementsForName:(NSString *)name;
- (NSArray *)elementsForLocalName:(NSString *)localName URI:(NSString *)URI;

- (NSArray *)attributes;
- (GDataXMLNode_W *)attributeForName:(NSString *)name;
- (GDataXMLNode_W *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
- (void)addAttribute:(GDataXMLNode_W *)attribute;

- (NSString *)resolvePrefixForNamespaceURI:(NSString *)namespaceURI;

@end

@interface GDataXMLDocument_W : NSObject {
@protected
...
- (id)initWithRootElement:(GDataXMLElement_W *)element;

- (GDataXMLElement_W *)rootElement;
